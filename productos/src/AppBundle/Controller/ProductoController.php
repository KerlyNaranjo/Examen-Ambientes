...
class ProductoController extends Controller
{
    ...
    {
        //coger del ID del user loguiado
        $idUser = $this->get('security.token_storage')->getToken()->getUser()->getId();
        //consulta de los productos del id del usuario loguiado
        $usuario = $this->getDoctrine()->getRepository('AppBundle:User')->find($idUser);
        
        
        
        $productos = $usuario->getProducto();

        return $this->render('producto/productos.html.twig', array(
            'productos' => $productos,
        ));
    }
